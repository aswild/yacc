...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.renamerecipe_button = QtGui.QPushButton(self.centralwidget)
        self.renamerecipe_button.setObjectName(_fromUtf8("renamerecipe_button"))
        self.horizontalLayout.addWidget(self.renamerecipe_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.renamerecipe_button.setText(_translate("MainWindow", "Rename Recipe", None))
        ...
        self.label_2.setText(_translate("MainWindow", "Recipe Contents:", None))
